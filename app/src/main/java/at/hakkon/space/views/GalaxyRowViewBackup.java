...
public class GalaxyRowViewBackup extends LinearLayout implements IPlanetVisitListener{
	...
	public GalaxyRowViewBackup(Context context, PlayerShip ship, ArrayList<AbsPlanet> planets) {
		super(context);
	...
	public void updateView() {
		...
		for (AbsPlanet planet: planets){
			...
			switch (position){
				case 0: addButtonListener((Button) view.findViewById(R.id.bPos0), planet); posExists0 = true; ((Button)view.findViewById(R.id.bPos0)).setText(planet.getName()); break;
				case 1: addButtonListener((Button) view.findViewById(R.id.bPos1), planet); posExists1 = true; ((Button)view.findViewById(R.id.bPos1)).setText(planet.getName()); break;
				case 2: addButtonListener((Button) view.findViewById(R.id.bPos2), planet); posExists2 = true; ((Button)view.findViewById(R.id.bPos2)).setText(planet.getName()); break;
				case 3: addButtonListener((Button) view.findViewById(R.id.bPos3), planet); posExists3 = true; ((Button)view.findViewById(R.id.bPos3)).setText(planet.getName()); break;
			}
		...
		if (!posExists0){
			...
			((Button)view.findViewById(R.id.bPos0)).setText("");
		}
		if (!posExists1){
			view.findViewById(R.id.bPos1).setVisibility(INVISIBLE);
			((Button)view.findViewById(R.id.bPos1)).setText("");
		}
		if (!posExists2){
			view.findViewById(R.id.bPos2).setVisibility(INVISIBLE);
			((Button)view.findViewById(R.id.bPos2)).setText("");
		}
		if (!posExists3){
			view.findViewById(R.id.bPos3).setVisibility(INVISIBLE);
			((Button)view.findViewById(R.id.bPos3)).setText("");
		}
